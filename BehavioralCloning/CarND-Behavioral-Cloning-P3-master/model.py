...
BATCH_SIZE = 128
EPOCHS = 3
MAIN_PATH = 'F:\\virtualenvs\\Udacity\\SelfDrivingCar_NanoDegree\\BehavioralCloning'
DATA_FILE = 'driving_log.csv'
IMGS_PATH = 'F:\\virtualenvs\\Udacity\\SelfDrivingCar_NanoDegree\\BehavioralCloning\\IMG'
LEARNING_RATE = 1e-4
...
def nvidia_model(resize_factor=0.5):
    ...
    # x = Cropping2D(cropping=((int(70 * resize_factor), int(25 * resize_factor)), (0, 0)),
    #                      input_shape=(int(160 * resize_factor), int(320 * resize_factor), 3))(x)
