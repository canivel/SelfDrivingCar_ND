...
def main():
    ...
    parser.add_argument('-d',    '--data_dir',        help='train data directory',       default='')
    parser.add_argument('-sf',   '--model_save_file', help='file to save the model',     default='model_v5.h5')
    parser.add_argument('-ft',   '--fine_tuning',     help='fine tuning option',         default='False')
    parser.add_argument('-lf',   '--model_load_file', help='fine tuning data directory', default='model_v5.h5')
